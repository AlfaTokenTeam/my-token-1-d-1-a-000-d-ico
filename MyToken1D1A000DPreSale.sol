...
import "./MyToken1D1A000D.sol";

contract MyToken1D1A000DPreSale {
    MyToken1D1A000D public token;
    ...
    function MyToken1D1A000DPreSale(
        MyToken1D1A000D _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken1D1A000D(_token);
